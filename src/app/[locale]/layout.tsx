...
import { cjkFontVariable } from "../../i18n/cjk-class";
...
export default async function LocaleLayout({
  ...
  const cjkVariable = await cjkFontVariable(locale);

  return (
    <html lang={htmlLang[locale]} className={`${sans.variable} ${mono.variable} ${cjkVariable} h-full antialiased`}>
